export default function AboutMe() {
  return (
    <div className="relative isolate overflow-hidden bg-white px-6 pb-14 pt-10 sm:pb-12 lg:overflow-visible lg:px-0">
      ...
      <div className="mx-auto grid max-w-2xl md:max-w-[50%] grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          ...
          <div className="lg:pr-4">
            <div className="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
              ...
              <p className="mt-6">
                ...
                interdum mauris enim, consequat vulputate nibh. Maecenas pellentesque id sed tellus mauris, ultrices mauris. Tincidunt enim
                cursus ridiculus mi. Pellentesque nam sed nullam sed diam turpis ipsum eu a sed convallis diam.
              </p>
            </div>
          </div>
        </div>
